...
public class Colors {
    ...
    public static final Vector4f[] levelBackgrounds = {background, blueBG, pinkBG, redBG, black};
    public static final Vector4f[] textColors = {backgroundDarker, blueDarker, pinkDarker, redDarker, tile};
}
